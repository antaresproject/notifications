...
namespace Antares\Templates\Memory\Tests;

use Antares\Templates\Memory\TemplatesMemory as Stub;
use Antares\Contracts\Memory\Handler;
...
class TemplatesMemoryTest extends TestCase
{
    ...
    protected function eloquentDataProvider()
    {
        ...
        return [
            new Fluent(['id' => 1, 'component_id' => 1, 'name' => 'foo', 'value' => 'a:1:{s:4:"test";s:6:"foobar";}']),
            new Fluent(['id' => 2, 'component_id' => 1, 'name' => 'hello', 'value' => 'a:1:{s:4:"test";s:5:"world";}']),
        ];
    }
