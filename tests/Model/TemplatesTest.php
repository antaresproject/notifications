...
use Antares\Templates\Model\Templates as Model;
...
class TemplatesTest extends TestCase
{
    ...
    {
        $this->assertSame($this->model->getMorphClass(), 'Templates');
    }
    ...
    {
        $this->assertSame('tbl_notification_templates', $this->model->getTable());
    }

    /**
     * has valid relation to component table
     */
    public function testComponent()
    {
        $component = $this->model->component();
        $this->assertInstanceOf(HasOne::class, $component);
        $this->assertInstanceOf(Component::class, $component->getModel());
    }
